...
class OperatingSystemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operating_system" do
    assert_difference('OperatingSystem.count') do
      post operating_systems_url, params: { operating_system: { description: @operating_system.description, end_of_life: @operating_system.end_of_life, name: @operating_system.name, order: @operating_system.order } }
    end
  ...
  test "should update operating_system" do
    patch operating_system_url(@operating_system), params: { operating_system: { description: @operating_system.description, end_of_life: @operating_system.end_of_life, name: @operating_system.name, order: @operating_system.order } }
